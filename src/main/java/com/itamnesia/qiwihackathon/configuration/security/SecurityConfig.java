    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(authorizeRequestsConfig -> authorizeRequestsConfig
                        ...
                        .antMatchers("/api/client/***", "/api/payments/purchases").hasAnyAuthority(Role.CLIENT.name(), Role.SHOP.name())
                        .antMatchers("/api/shop/account", "/api/payments/sales").hasAuthority(Role.SHOP.name())
